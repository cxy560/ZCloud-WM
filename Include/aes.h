...
/*
	CBC Mode AES
*/
PSPUBLIC int32 psAesInit(psAesCipherContext_t *ctx, unsigned char *IV,
						unsigned char *key, uint32 keylen);
PSPUBLIC int32 psAesDecrypt(psAesCipherContext_t *ctx, unsigned char *ct,
						unsigned char *pt, uint32 len);
PSPUBLIC int32 psAesEncrypt(psAesCipherContext_t *ctx, unsigned char *pt,
